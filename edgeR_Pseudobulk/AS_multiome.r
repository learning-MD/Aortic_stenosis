...
parFile1='/nobackup/shah_lab/shengq2/20231101_AS_multiome_Michelle/data/vandy_AS_full_processed.forDE.rds'
parFile2=''
parFile3=''


setwd('/nobackup/shah_lab/shengq2/20231113_AS_multiome_Michelle_celltype_DE_fold1.2/files_edgeR_inCluster_bySample/result')
